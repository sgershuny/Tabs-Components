...
class TabLink {
  constructor(element) {
    ...
    // let itemArray = Array.from(document.querySelectorAll('.tabs-item'));
    // console.log(itemArray);
    // this.itemElement = itemArray.filter((item)=> item.dataset.tab === this.data);
    this.itemElement = document.querySelectorAll('.tabs-item')[this.data-1];
